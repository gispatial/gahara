...
function (_React$Component) {
  ...
  function Calendar(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleDateChange", function (data) {
      ...
      if (Array.isArray(data.date)) {
        updatedDate = data.date.map(function (date, index) {
          newTimeState[index] = (0, _index4.applyDateToTime)(newTimeState[index], date);
          return newTimeState[index];
        });
      } else if (!Array.isArray(_this.props.value) && data.date) {
        newTimeState[0] = (0, _index4.applyDateToTime)(newTimeState[0], data.date);
    ...
    _defineProperty(_assertThisInitialized(_this), "handleTimeChange", function (time, index) {
      ...
      newTimeState[index] = (0, _index4.applyTimeToDate)(newTimeState[index], time);
    ...
    if (Array.isArray(_this.props.value)) {
      _time = _this.props.value;
    } else if (_this.props.value) {
      _time = [_this.props.value];
    }

    _this.state = {
      highlightedDate: _this.getSingleDate(_value) || (_highlightedDate && (0, _index4.isSameMonth)(dateInView, _highlightedDate) ? _highlightedDate : new Date()),
      focused: false,
      date: dateInView,
      quickSelectId: null,
      rootElement: null,
